...
const Landing = () => {
  return (
    <div
      data-scroll
      data-scroll-speed="-.9"
      className="w-full h-screen text-[#212121] mt-10"
    >
      <div className="relative overflow-hidden font-founder text-[9rem] tracking-wide leading-none ml-16">
        <h2 className="m-0 translate-y-[0.25em] uppercase"> we create</h2>
        <h2 className="m-0  uppercase flex gap-3 items-center justify-start">
          {' '}
          <motion.img
            initial={{ width: 0 }}
            animate={{ width: '155px' }}
            transition={{ duration: 1, delay: 0.5, ease: [0.76, 0, 0.24, 1] }}
            className="h-22.75 mt-4 rounded-md"
            src={contentImage}
            alt="ochi"
          />{' '}
        ...
        <motion.a
          ...
          href="https://www.awwwards.com/sites/ochi-design"
        >
          <svg width="50" height="160">
            <path
              class="js-color-bg"
              fill="#E73C37"
      ...
      <div className="font-neuemontreal flex justify-around mt-4 text-xl">
        ...
        <div className="flex gap-4">
          <div className="uppercase border-2 rounded-full pt-2.5 px-6 text-base cursor-pointer transition ease-in duration-200 hover:bg-[#212121] hover:text-[#fafafa] ">
            Start the project
          </div>
          <div className="size-12 border-2 rounded-full flex items-center justify-center">
            <FiArrowUpRight />
          </div>
        </div>
      </div>
